...
BOOST_AUTO_TEST_CASE(BasicTest)
{
    ...
    BOOST_CHECK_EQUAL(std::any_cast<std::string>(tree.getLeftmost(tree.getRoot())->data), "1");

    BOOST_CHECK_EQUAL(tree.getRightmost(tree.getRoot())->key, 34);
    BOOST_CHECK_EQUAL(std::any_cast<std::string>(tree.getRightmost(tree.getRoot())->data), "34");
...
BOOST_AUTO_TEST_CASE(DeletionTest)
{
    ...
    tree->deleteNode(15);
    {
        const std::vector<std::pair<int32_t, std::string>> expectedData{
            {23, "23"}, {4, "4"}, {30, "30"}, {1, "1"}, {11, "11"}, {24, "24"}, {34, "34"}, {7, "7"}, {20, "20"}, {22, "22"}};
    ...
    {
        const std::vector<std::pair<int32_t, std::string>> expectedData{
            {23, "23"}, {4, "4"}, {30, "30"}, {1, "1"}, {11, "11"}, {24, "24"}, {34, "34"}, {7, "7"}, {22, "22"}};
        TraversalOutput output = LevelOrderTraverse(tree);
    ...
    {
        const std::vector<std::pair<int32_t, std::string>> expectedData{
            {23, "23"}, {4, "4"}, {30, "30"}, {1, "1"}, {11, "11"}, {24, "24"}, {34, "34"}, {7, "7"}, {17, "17"}};
        TraversalOutput output = LevelOrderTraverse(tree);
    ...
    {
        const std::vector<std::pair<int32_t, std::string>> expectedData{
            {23, "23"}, {4, "4"}, {30, "30"}, {1, "1"}, {17, "17"}, {24, "24"}, {34, "34"}, {7, "7"}};
        TraversalOutput output = LevelOrderTraverse(tree);
